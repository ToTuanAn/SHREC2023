...
def preprocessing_pc(
    off_path="/home/totuanan/Workplace/SHREC2023/SHREC2023/dataset/PC_OFF/",
):
    for file in os.listdir(off_path):
        ...
        with open(
            f"/home/totuanan/Workplace/SHREC2023/SHREC2023/dataset/pointcloud/{file[:-4]}.txt",
            "w+",
        ) as f:
...
def create_validation_set(
    path="/home/totuanan/Workplace/SHREC2023/SHREC2023/dataset/text_queries",
):
